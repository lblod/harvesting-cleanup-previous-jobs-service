...
export async function getLastDumpFileJobDate() {
  console.log("Dump file logic is deprecated - using date-based retention only");
...
export async function getSuccessfulJobsBeforeDate() {
  ...
  console.log(`Found ${jobsToClean.length} successful jobs older than ${maxDaysToKeepSuccessfulJobs.toISOString()}`);
